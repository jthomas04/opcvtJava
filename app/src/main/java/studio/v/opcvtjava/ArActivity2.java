...
public class ArActivity2 extends BaseCVCameraActivity {
    ...
    private static final String TAG = "MC2 MkII Activity";
    private int W, H;
...
//    protected GLSurfaceView glv;
    ...
    private org.rajawali3d.view.SurfaceView sv;
    private BaseRenderer bR;

    private int nMatches = 0, nGMatches = 0, nFrameKps = 0, nInliers = 0, nTMatches = 0; // ExTrA UnEcEsSaRy MoNkEyS, ThEsE all IdIoTiC CoUnTeRs ThEy JuSt CoUnT, bEtTeR wAy NoW wItH @i.
...
//Commented out cuz Base class' onCreate does the needful
//    @Override
...
//    }
    ...
    protected void createContentView(){
        ...
        sv.setFrameRate(60.0);
        sv.setRenderMode(ISurface.RENDERMODE_WHEN_DIRTY);
        sv.setTransparent(true);

        bR = new BaseRenderer(this);
        sv.setSurfaceRenderer(bR);
    }
    ...
    protected void onOpenCVReady(){
        ...
        try {
            t.marker = Utils.loadResource(this, R.raw.marker2);
            t.analyzeMarker();
            ...
            t.setText("Marker Failed to Load!! Maybe Read permissions are lacking!");
...
//Following lines not nececssary cuz the same functionality is handled by the Base class BaseCVActivity
//    @Override
//    public void onPause(){
//        super.onPause();
//        if(mOpenCvCameraView!=null)
...
//        */
        ...
        if(!artrun){
            ...
            if(finalState == ART.HomoReady || finalState == ART.accumHomo) {
                ...
                Log.w(TAG, " vc = " + t.tv.dump() + t.rv.dump() );
            ...
            Log.w(TAG,"fast KPS = " + detectedKeypoints.size());
//
        }
        if(homoCompute){
            ...
            if (!t.checkIfConvex(scene_corners)){
                ...
                drawLinesAroundMarker(scene_corners, scene_corners2); //TODO: Remove this line
...
//    }
    ...
    public void showStats( int state, Mat src){
        ...
        message = "# of Matches: " + nMatches + " G.M's :" + nGMatches + "Trckr:" + nTMatches + " Inliers :" + nInliers + " | Fr : " + nFrameKps + " Mark :" + t.nMarkerKps;
