...
public class eObjParser extends AParser {
    private final static String TAG = "eObjParser:";

    InputStream fileIn;
    public eObjParser(InputStream in){
        super();
        fileIn = in;
    }

    //Copied functions & constants From min3d.parser.OjParser
